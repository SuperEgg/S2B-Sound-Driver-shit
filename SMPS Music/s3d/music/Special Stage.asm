...
smpsHeaderStartSong= 3
	smpsHeaderVoice     S3D_SpecialS_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $10

	smpsHeaderDAC       S3D_SpecialS_DAC
	smpsHeaderFM        S3D_SpecialS_FM1,	$FF, $10
	smpsHeaderFM        S3D_SpecialS_FM2,	$FF, $16
	smpsHeaderFM        S3D_SpecialS_FM3,	$FF, $12
	smpsHeaderFM        S3D_SpecialS_FM4,	$FF, $12
	smpsHeaderFM        S3D_SpecialS_FM5,	$FF, $14
	smpsHeaderPSG       S3D_SpecialS_PSG1,	$00, $06, $00, sTone_06
	smpsHeaderPSG       S3D_SpecialS_PSG2,	$00, $07, $00, sTone_04
	smpsHeaderPSG       S3D_SpecialS_PSG3,	$23, $01, $00, sTone_03
...
S3D_SpecialS_Loop00:
	smpsCall            S3D_SpecialS_Call00
	smpsCall            S3D_SpecialS_Call01
	smpsCall            S3D_SpecialS_Call00
	smpsCall            S3D_SpecialS_Call02
	smpsCall            S3D_SpecialS_Call00
	smpsCall            S3D_SpecialS_Call01
	smpsCall            S3D_SpecialS_Call03
	smpsCall            S3D_SpecialS_Call04
	smpsLoop            $01, $02, S3D_SpecialS_Loop00

S3D_SpecialS_Loop01:
	smpsCall            S3D_SpecialS_Call05
	smpsCall            S3D_SpecialS_Call06
	smpsCall            S3D_SpecialS_Call05
	smpsCall            S3D_SpecialS_Call07
	smpsLoop            $01, $02, S3D_SpecialS_Loop01

S3D_SpecialS_Loop02:
	smpsCall            S3D_SpecialS_Call08
	smpsLoop            $01, $02, S3D_SpecialS_Loop02

S3D_SpecialS_Loop03:
	smpsCall            S3D_SpecialS_Call09
	smpsLoop            $01, $03, S3D_SpecialS_Loop03
	smpsJump            S3D_SpecialS_Loop00
...
S3D_SpecialS_Loop05:
	...
	dc.b	$0C
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $03, S3D_SpecialS_Loop05
	smpsReturn
...
S3D_SpecialS_Call01:
	...
	dc.b	$0C
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $04, S3D_SpecialS_Call01
	smpsReturn
...
S3D_SpecialS_Call02:
	...
	dc.b	$0C
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $02, S3D_SpecialS_Call02
	smpsPSGvoice        sTone_12
	dc.b	$30
	smpsReturn
...
S3D_SpecialS_Call03:
	...
	dc.b	$0C
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $02, S3D_SpecialS_Call03
	smpsReturn
...
S3D_SpecialS_Call04:
	...
	dc.b	$06
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $03, S3D_SpecialS_Call04
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	dc.b	$06
	smpsPSGAlterVol     $FF
...
S3D_SpecialS_Loop04:
	...
	dc.b	$06
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $03, S3D_SpecialS_Loop04
	smpsReturn
...
S3D_SpecialS_Call06:
	...
	dc.b	$06
	smpsPSGAlterVol     $FF
	smpsLoop            $00, $03, S3D_SpecialS_Call06
	smpsPSGvoice        sTone_0F
	smpsPSGAlterVol     $02
	dc.b	$06
	smpsPSGAlterVol     $FF
