...
smpsHeaderStartSong= 3
	smpsHeaderVoice     S3D_Title_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $04

	smpsHeaderDAC       S3D_Title_DAC
	smpsHeaderFM        S3D_Title_FM1,	$D4, $0B
	smpsHeaderFM        S3D_Title_FM2,	$00, $03
	smpsHeaderFM        S3D_Title_FM3,	$00, $05
	smpsHeaderFM        S3D_Title_FM4,	$FC, $18
	smpsHeaderFM        S3D_Title_FM5,	$FC, $09
	smpsHeaderPSG       S3D_Title_PSG1,	$FC, $02, $00, $00
	smpsHeaderPSG       S3D_Title_PSG2,	$FC, $04, $00, $00
	smpsHeaderPSG       S3D_Title_PSG3,	$23, $01, $00, $00

; FM1 Data
S3D_Title_FM1:
	smpsSetvoice        $00
	dc.b	nRst, $60, nRst
	smpsCall            S3D_Title_Call00
	smpsCall            S3D_Title_Call00
	smpsCall            S3D_Title_Call01
	dc.b	nB0, nRst, nB1, nB1, nC1, nRst, nC2, nC2, nD1, nE1, nD1, nC1
	dc.b	nB0, nA0, nG0, smpsNoAttack, nG0
	smpsCall            S3D_Title_Call02
	smpsCall            S3D_Title_Call03
	smpsCall            S3D_Title_Call00
	smpsCall            S3D_Title_Call00
	smpsStop
...
S3D_Title_Loop02:
	...
	smpsFMAlterVol      $FF
	smpsLoop            $00, $1F, S3D_Title_Loop02
...
S3D_Title_Loop01:
	dc.b	smpsNoAttack, nFs6
	smpsFMAlterVol      $FF
	smpsLoop            $00, $1F, S3D_Title_Loop01
	smpsPan             panCenter, $00
	smpsSetvoice        $05
	smpsAlterNote       $02
	smpsAlterPitch      $FC
...
S3D_Title_Loop05:
	...
	smpsLoop            $00, $02, S3D_Title_Loop05

S3D_Title_Loop06:
	dc.b	nB2, nF3, nB2, nF3, nB2, nF3, nB2, nF3
	smpsLoop            $00, $02, S3D_Title_Loop06
...
S3D_Title_Loop04:
	...
	smpsLoop            $00, $02, S3D_Title_Loop04
...
S3D_Title_Loop03:
	smpsCall            S3D_Title_Call04
	smpsLoop            $00, $0A, S3D_Title_Loop03
	smpsStop
...
S3D_Title_Loop00:
	...
	smpsLoop            $00, $06, S3D_Title_Loop00
