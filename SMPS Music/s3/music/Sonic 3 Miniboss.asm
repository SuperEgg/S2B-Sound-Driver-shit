...
smpsHeaderStartSong = 3
	smpsHeaderVoice     S3_Miniboss_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $44

	smpsHeaderDAC       S3_Miniboss_DAC
	smpsHeaderFM        S3_Miniboss_FM1,	$C2, $03
	smpsHeaderFM        S3_Miniboss_FM2,	$0C, $0B
	smpsHeaderFM        S3_Miniboss_FM3,	$0C, $10
	smpsHeaderFM        S3_Miniboss_FM4,	$00, $14
	smpsHeaderFM        S3_Miniboss_FM5,	$00, $14
	smpsHeaderPSG       S3_Miniboss_PSG1,	$00, $00, $00, $00
	smpsHeaderPSG       S3_Miniboss_PSG2,	$03, $01, $00, $00
	smpsHeaderPSG       S3_Miniboss_PSG3,	$00, $00, $00, $00

; FM1 Data
S3_Miniboss_FM1:
	smpsSetvoice        $04
	dc.b	nC1, $18, nRst, $48
	smpsCall            S3_Miniboss_Call05
	smpsCall            S3_Miniboss_Call06
	smpsCall            S3_Miniboss_Call05
	smpsCall            S3_Miniboss_Call07
	smpsCall            S3_Miniboss_Call05
	smpsCall            S3_Miniboss_Call06
	smpsCall            S3_Miniboss_Call05
	smpsCall            S3_Miniboss_Call08
	smpsCall            S3_Miniboss_Call09
	smpsCall            S3_Miniboss_Call0A
	smpsCall            S3_Miniboss_Call09
	smpsCall            S3_Miniboss_Call0B
	smpsCall            S3_Miniboss_Call09
	smpsCall            S3_Miniboss_Call0A
	smpsCall            S3_Miniboss_Call0C
	smpsCall            S3_Miniboss_Call0B
...
S3_Miniboss_FM2:
	...
	smpsCall            S3_Miniboss_Call03
	smpsCall            S3_Miniboss_Call04
	smpsCall            S3_Miniboss_Call03
...
S3_Miniboss_FM3:
	...
	smpsCall            S3_Miniboss_Call01

S3_Miniboss_Loop00:
	dc.b	nRst, $5B, nEb4, $03, nRst, $02
	smpsCall            S3_Miniboss_Call01
	smpsLoop            $00, $03, S3_Miniboss_Loop00
	smpsCall            S3_Miniboss_Call02
	dc.b	nRst, $60, nRst, $2B, nEb4, $05, nFs4, nRst, $07, nFs4, $05, nRst
	dc.b	$07, nFs4, nAb4, $05, nBb4, $07, nAb4, $05, nRst, $60
	smpsCall            S3_Miniboss_Call02
	smpsCall            S3_Miniboss_Call00
	smpsAlterPitch      $0C
	smpsJump            S3_Miniboss_FM3
...
S3_Miniboss_Loop06:
	dc.b	nRst, $5B, nEb4, $03, nRst, $02
	smpsCall            S3_Miniboss_Call01
	smpsLoop            $00, $03, S3_Miniboss_Loop06
	smpsCall            S3_Miniboss_Call02
	dc.b	nRst, $60, nRst, $2B, nEb4, $05, nFs4, nRst, $07, nFs4, $05, nRst
	dc.b	$07, nFs4, nAb4, $05, nBb4, $07, nAb4, $05, nRst, $60
	smpsCall            S3_Miniboss_Call02
...
S3_Miniboss_Loop02:
	smpsCall            S3_Miniboss_Call0D
	smpsLoop            $00, $03, S3_Miniboss_Loop02
	dc.b	nBb6, $0C, nBb6, nBb6, nBb6, nBb6, nBb6, nBb6, nRst

S3_Miniboss_Loop03:
	smpsCall            S3_Miniboss_Call0D
	smpsLoop            $00, $03, S3_Miniboss_Loop03
	dc.b	nBb6, $07
	smpsPSGAlterVol     $04
	dc.b	$05, $07
	smpsPSGAlterVol     $FC
...
S3_Miniboss_Loop04:
	smpsCall            S3_Miniboss_Call0D
	smpsLoop            $00, $03, S3_Miniboss_Loop04
	dc.b	nRst, $60

S3_Miniboss_Loop05:
	smpsCall            S3_Miniboss_Call0D
	smpsLoop            $00, $03, S3_Miniboss_Loop05
	dc.b	nBb6, $0C, nRst, $07, nBb6, $05, nRst, $0C, nBb6, nBb6, nBb6, nBb6
	dc.b	nRst, nRst, $60, nRst, nRst
	smpsJump            S3_Miniboss_PSG3
