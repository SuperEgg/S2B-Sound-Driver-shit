...
smpsHeaderStartSong = 3
	smpsHeaderVoice     S3_Knux_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $43

	smpsHeaderDAC       S3_Knux_DAC
	smpsHeaderFM        S3_Knux_FM1,	$C2, $03
	smpsHeaderFM        S3_Knux_FM2,	$E0, $18
	smpsHeaderFM        S3_Knux_FM3,	$0C, $10
	smpsHeaderFM        S3_Knux_FM4,	$00, $14
	smpsHeaderFM        S3_Knux_FM5,	$00, $14
	smpsHeaderPSG       S3_Knux_PSG1,	$03, $01, $00, $00
	smpsHeaderPSG       S3_Knux_PSG2,	$00, $01, $00, $00
	smpsHeaderPSG       S3_Knux_PSG3,	$00, $00, $00, $00
...
; DAC Data
S3_Knux_DAC:
	smpsCall            S3_Knux_Call00
	smpsLoop            $00, $04, S3_Knux_DAC

S3_Knux_Jump00:
	smpsCall            S3_Knux_Call01

S3_Knux_Loop00:
	smpsCall            S3_Knux_Call00
	smpsLoop            $00, $03, S3_Knux_Loop00
	smpsJump            S3_Knux_Jump00
