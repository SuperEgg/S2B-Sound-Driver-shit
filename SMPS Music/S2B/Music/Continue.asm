Continue_Beta_Header:
smpsHeaderStartSong = 1
	smpsHeaderVoice     Continue_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $07

	smpsHeaderDAC       Continue_Beta_DAC
	smpsHeaderFM        Continue_Beta_FM1,	$E5, $08
	smpsHeaderFM        Continue_Beta_FM2,	$E8, $08
	smpsHeaderFM        Continue_Beta_FM3,	$F4, $0F
	smpsHeaderFM        Continue_Beta_FM4,	$F4, $0F
	smpsHeaderFM        Continue_Beta_FM5,	$F4, $0A
	smpsHeaderPSG       Continue_Beta_PSG1,	$D0, $03, $00, fTone_05
	smpsHeaderPSG       Continue_Beta_PSG2,	$DC, $06, $00, fTone_05
	smpsHeaderPSG       Continue_Beta_PSG3,	$DC, $00, $00, fTone_04
...
Continue_Beta_Loop00:
	dc.b	dKick, $0C, dSnare
	smpsLoop            $00, $0E, Continue_Beta_Loop00
	dc.b	dKick, $0C, dSnare, $06, dKick, $0C
	smpsStop

Continue_Beta_Voices:
;	Voice $00
;	$3A
