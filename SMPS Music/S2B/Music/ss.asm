...
smpsHeaderStartSong = 1
	smpsHeaderVoice     SS_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $00

	smpsHeaderDAC       SS_Beta_DAC
	smpsHeaderFM        SS_Beta_FM1,	$0C, $0A
	smpsHeaderFM        SS_Beta_FM2,	$00, $05
	smpsHeaderFM        SS_Beta_FM3,	$00, $0E
	smpsHeaderFM        SS_Beta_FM4,	$00, $0E
	smpsHeaderFM        SS_Beta_FM5,	$00, $0F
	smpsHeaderPSG       SS_Beta_PSG1,	$DC, $02, $00, fTone_0B
	smpsHeaderPSG       SS_Beta_PSG2,	$DC, $04, $00, fTone_0B
	smpsHeaderPSG       SS_Beta_PSG3,	$00, $01, $00, $00
...
SS_Beta_Loop0C:
	...
	smpsLoop            $00, $07, SS_Beta_Loop0C
	smpsJump            SS_Beta_Loop0C
...
SS_Beta_Loop0B:
	...
	dc.b	nAb4, $18, nRst
	smpsLoop            $00, $02, SS_Beta_Loop0B
	smpsAlterVol        $02
	smpsJump            SS_Beta_Loop0A
...
SS_Beta_Loop09:
	...
	dc.b	nRst, nCs5, nE5, $12, nB4, $06, nRst, nB4, nRst, nCs5, nB4, $12
	dc.b	nAb4, $18, nRst
	smpsLoop            $00, $02, SS_Beta_Loop09
	smpsAlterNote       $00
	smpsAlterVol        $08
	smpsJump            SS_Beta_Loop08
...
SS_Beta_Loop06:
	...
	dc.b	nE4, $18, nRst
	smpsLoop            $00, $02, SS_Beta_Loop06
	smpsJump            SS_Beta_Loop05
...
SS_Beta_Loop03:
	...
	smpsPan             panCenter, $00
	dc.b	nD5
	smpsLoop            $00, $1C, SS_Beta_Loop03
	smpsJump            SS_Beta_Loop03
...
SS_Beta_Loop02:
	...
	smpsLoop            $00, $02, SS_Beta_Loop02
	smpsJump            SS_Beta_Loop01
...
SS_Beta_Loop0E:
	...
	smpsLoop            $00, $04, SS_Beta_Loop0E

SS_Beta_Loop0F:
	dc.b	nA5, $18, $06, nA5, $0C, nA5, nA5, $06, nA5, $0C, nA5, nA5
	smpsLoop            $00, $04, SS_Beta_Loop0F

SS_Beta_Loop10:
	dc.b	nA5, $0C, $06, nA5, nA5, nA5, $0C, nA5, nA5, $06, nA5, nA5
	dc.b	nA5, $0C, nA5
	smpsLoop            $00, $04, SS_Beta_Loop10
	smpsJump            SS_Beta_Loop0E
