...
smpsHeaderStartSong = 1
	smpsHeaderVoice     CNZ_2P_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $03

	smpsHeaderDAC       CNZ_2P_Beta_DAC
	smpsHeaderFM        CNZ_2P_Beta_FM1,	$F4, $08
	smpsHeaderFM        CNZ_2P_Beta_FM2,	$F4, $0D
	smpsHeaderFM        CNZ_2P_Beta_FM3,	$F4, $10
	smpsHeaderFM        CNZ_2P_Beta_FM4,	$E8, $0E
	smpsHeaderFM        CNZ_2P_Beta_FM5,	$F4, $10
	smpsHeaderPSG       CNZ_2P_Beta_PSG1,	$D0, $04, $00, $00
	smpsHeaderPSG       CNZ_2P_Beta_PSG2,	$D0, $04, $00, $00
	smpsHeaderPSG       CNZ_2P_Beta_PSG3,	$C4, $05, $00, $00
...
CNZ_2P_Beta_Loop0B:
	...
	dc.b	nBb3, nRst, $2A
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop0B
	smpsCall            CNZ_2P_Beta_Call0C
...
CNZ_2P_Beta_FM2:
	smpsSetvoice        $01
	smpsCall            CNZ_2P_Beta_Call05

CNZ_2P_Beta_Loop08:
	smpsCall            CNZ_2P_Beta_Call06
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop08
	smpsSetvoice        $03
	smpsAlterNote       $02
	smpsAlterVol        $07

CNZ_2P_Beta_Loop09:
	smpsCall            CNZ_2P_Beta_Call07
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop09

CNZ_2P_Beta_Loop0A:
	smpsCall            CNZ_2P_Beta_Call08
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop0A
	smpsSetvoice        $01
	smpsAlterNote       $00
	smpsAlterVol        $F9
	smpsCall            CNZ_2P_Beta_Call0A
	smpsCall            CNZ_2P_Beta_Call0B
	smpsJump            CNZ_2P_Beta_Loop08
...
CNZ_2P_Beta_Loop06:
	...
	dc.b	$06, nRst
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop06
	smpsAlterVol        $04
	smpsPan             panRight, $00
...
CNZ_2P_Beta_Loop07:
	...
	dc.b	nA5, $03, nRst, $0C
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop07
	smpsAlterVol        $FC
...
CNZ_2P_Beta_Loop03:
	smpsCall            CNZ_2P_Beta_Call06
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop03
	smpsSetvoice        $03
	smpsAlterNote       $00
	smpsAlterPitch      $0C
	smpsAlterVol        $04
...
CNZ_2P_Beta_Loop04:
	smpsCall            CNZ_2P_Beta_Call07
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop04

CNZ_2P_Beta_Loop05:
	smpsCall            CNZ_2P_Beta_Call08
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop05
	smpsSetvoice        $01
	smpsCall            CNZ_2P_Beta_Call09
...
CNZ_2P_Beta_Loop02:
	...
	dc.b	nD6, $06, nRst
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop02
	smpsSetvoice        $04
	smpsPan             panCenter, $00
	dc.b	nRst, $60
	smpsCall            CNZ_2P_Beta_Call01
	dc.b	nRst, $60
	smpsCall            CNZ_2P_Beta_Call02
	smpsSetvoice        $03
	smpsAlterVol        $02
	smpsPan             panLeft, $00
	smpsModSet          $01, $01, $03, $03
	smpsCall            CNZ_2P_Beta_Call03
	smpsSetvoice        $04
	smpsAlterVol        $FC
	smpsPan             panCenter, $00
	smpsCall            CNZ_2P_Beta_Call01
...
CNZ_2P_Beta_Loop10:
	...
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop10
...
CNZ_2P_Beta_Loop0D:
	...
	smpsLoop            $00, $02, CNZ_2P_Beta_Loop0D
...
CNZ_2P_Beta_Loop00:
	smpsCall            CNZ_2P_Beta_Call00
	smpsLoop            $00, $03, CNZ_2P_Beta_Loop00
	dc.b	dKick, $09, dKick, $03, $0C, dSnare, dKick, dKick, $15, dSnare, $03, $18

CNZ_2P_Beta_Loop01:
	smpsCall            CNZ_2P_Beta_Call00
	smpsLoop            $00, $0F, CNZ_2P_Beta_Loop01
	dc.b	nRst, $09, dKick, $0F, dSnare, $0C, dKick, $09, dSnare, $1B, $0C, $09
	dc.b	$03
	smpsJump            CNZ_2P_Beta_Loop00
