...
smpsHeaderStartSong = 1
	smpsHeaderVoice     SCZ_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $03

	smpsHeaderDAC       SCZ_Beta_DAC
	smpsHeaderFM        SCZ_Beta_FM1,	$F4, $10
	smpsHeaderFM        SCZ_Beta_FM2,	$DC, $24
	smpsHeaderFM        SCZ_Beta_FM3,	$F4, $12
	smpsHeaderFM        SCZ_Beta_FM4,	$F4, $09
	smpsHeaderFM        SCZ_Beta_FM5,	$E8, $0E
	smpsHeaderPSG       SCZ_Beta_PSG1,	$F4, $0C, $00, $00
	smpsHeaderPSG       SCZ_Beta_PSG2,	$F9, $09, $00, $00
	smpsHeaderPSG       SCZ_Beta_PSG3,	$02, $04, $00, $00
...
SCZ_Beta_Loop03:
	smpsCall            SCZ_Beta_Call07
	smpsLoop            $00, $02, SCZ_Beta_Loop03
...
SCZ_Beta_Loop04:
	smpsCall            SCZ_Beta_Call07
	smpsLoop            $00, $08, SCZ_Beta_Loop04
	smpsJump            SCZ_Beta_Jump03
...
SCZ_Beta_Jump02:
	...
	dc.b	nD6, $30
	smpsAlterVol        $05
	smpsJump            SCZ_Beta_Jump02

SCZ_Beta_Call05:
	dc.b	nG6, $30, nD6
	smpsLoop            $00, $04, SCZ_Beta_Call05
	smpsReturn
...
SCZ_Beta_Jump01:
	...
	smpsSetvoice        $00
	smpsCall            SCZ_Beta_Call04
	dc.b	nB4, $0C, nG4, nA4, nG4, $06, nA4
	smpsCall            SCZ_Beta_Call04
	dc.b	nB4, $30
	smpsJump            SCZ_Beta_Jump01

SCZ_Beta_Call04:
	dc.b	nB4, $0C, nG4, nA4, nD4
	smpsLoop            $00, $03, SCZ_Beta_Call04
	smpsReturn
...
SCZ_Beta_Loop02:
	...
	smpsLoop            $00, $04, SCZ_Beta_Loop02
	smpsCall            SCZ_Beta_Call02
	dc.b	nA3, $03, $0F, $0C, $09, $09, nG3, $03, $0F, $0C, $06, nA3
	dc.b	nB3
	smpsCall            SCZ_Beta_Call02
	dc.b	nA3, $03, $0F, $0C, $06, nB3, nA3, nG3, $30
	smpsJump            SCZ_Beta_Loop02
...
; DAC Data
SCZ_Beta_DAC:
	smpsCall            SCZ_Beta_Call00
	smpsLoop            $00, $02, SCZ_Beta_DAC

SCZ_Beta_Loop00:
	smpsCall            SCZ_Beta_Call00
	smpsLoop            $00, $03, SCZ_Beta_Loop00
	smpsCall            SCZ_Beta_Call01
	smpsLoop            $01, $03, SCZ_Beta_Loop00

SCZ_Beta_Loop01:
	smpsCall            SCZ_Beta_Call00
	smpsLoop            $00, $03, SCZ_Beta_Loop01
	dc.b	dKick, $0C, nRst, nRst, dSnare, $06, dSnare, $03, dSnare
	smpsJump            SCZ_Beta_Loop00
...
SCZ_Beta_Loop05:
	dc.b	nG4, $30, nFs4
	smpsLoop            $00, $04, SCZ_Beta_Loop05
	smpsAlterVol        $FE
