...
smpsHeaderStartSong = 1
	smpsHeaderVoice     CPZ_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $0C

	smpsHeaderDAC       CPZ_Beta_DAC
	smpsHeaderFM        CPZ_Beta_FM1,	$00, $0A
	smpsHeaderFM        CPZ_Beta_FM2,	$00, $12
	smpsHeaderFM        CPZ_Beta_FM3,	$00, $12
	smpsHeaderFM        CPZ_Beta_FM4,	$00, $12
	smpsHeaderFM        CPZ_Beta_FM5,	$00, $0E
	smpsHeaderPSG       CPZ_Beta_PSG1,	$00, $08, $00, $00
	smpsHeaderPSG       CPZ_Beta_PSG2,	$00, $08, $00, $00
	smpsHeaderPSG       CPZ_Beta_PSG3,	$00, $01, $00, fTone_02
...
CPZ_Beta_Loop10:
	...
	smpsAlterVol        $FF
	smpsLoop            $00, $02, CPZ_Beta_Loop10
	smpsCall            CPZ_Beta_Call08
	smpsCall            CPZ_Beta_Call09
	smpsCall            CPZ_Beta_Call08
	smpsSetvoice        $00
	dc.b	nCs4, $06, nE4, nFs4, nAb4, $02, smpsNoAttack, nA4, $0A, nFs4, $06, nCs4
...
CPZ_Beta_Loop0C:
	smpsCall            CPZ_Beta_Call02
	smpsLoop            $00, $02, CPZ_Beta_Loop0C

CPZ_Beta_Loop0D:
	smpsCall            CPZ_Beta_Call02
	smpsLoop            $00, $04, CPZ_Beta_Loop0D
	smpsModOff

CPZ_Beta_Loop0E:
	dc.b	nAb5, $12, nRst, $06, nAb5, $12, nRst, $06, nA5, $0C, nRst, $24
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, CPZ_Beta_Loop0E
...
CPZ_Beta_Loop08:
	smpsCall            CPZ_Beta_Call04
	smpsLoop            $00, $02, CPZ_Beta_Loop08

CPZ_Beta_Loop09:
	smpsCall            CPZ_Beta_Call04
	smpsLoop            $00, $04, CPZ_Beta_Loop09
	smpsModOff

CPZ_Beta_Loop0A:
	dc.b	nB5, $12, nRst, $06, nB5, $12, nRst, $06, nCs6, $0C, nRst, $24
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, CPZ_Beta_Loop0A
	smpsModSet          $0C, $01, $05, $04

CPZ_Beta_Loop0B:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $02, CPZ_Beta_Loop0B
	smpsSetvoice        $05
	smpsAlterVol        $F8
	dc.b	nFs5, $04, nRst, $08, nE5, $04, nRst, $08, nFs5, $0C, nE5, $06
	dc.b	nFs5, $04, nRst, $08, nFs5, $06, nE5, $04, nRst, $08, nFs5, $0C
...
CPZ_Beta_Loop04:
	smpsCall            CPZ_Beta_Call02
	smpsLoop            $00, $02, CPZ_Beta_Loop04

CPZ_Beta_Jump00:
	smpsSetvoice        $03

CPZ_Beta_Loop05:
	smpsCall            CPZ_Beta_Call03
	smpsLoop            $00, $03, CPZ_Beta_Loop05
	dc.b	nE2, $0C, nE3, $06, nRst, nEb3, nRst, nE3, nEb2, nRst, nEb2, nEb3
	dc.b	nRst, nCs3, nRst, nEb3, $0C
	smpsLoop            $01, $04, CPZ_Beta_Loop05
	dc.b	nRst, $30, nRst
...
CPZ_Beta_Loop06:
	smpsCall            CPZ_Beta_Call03
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $03, CPZ_Beta_Loop06
	smpsPan             panRight, $00
	dc.b	nRst, $30, nRst
	smpsSetvoice        $05
	smpsAlterVol        $F8
...
CPZ_Beta_Loop07:
	...
	smpsLoop            $00, $04, CPZ_Beta_Loop07
	smpsAlterVol        $08
	smpsJump            CPZ_Beta_Jump00
...
CPZ_Beta_Loop02:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $03, CPZ_Beta_Loop02
...
CPZ_Beta_Loop03:
	...
	dc.b	nEb2, $0C
	smpsLoop            $00, $04, CPZ_Beta_Loop03
	...
	smpsJump            CPZ_Beta_Loop03

; DAC Data
CPZ_Beta_DAC:
	smpsCall            CPZ_Beta_Call00
	smpsLoop            $00, $02, CPZ_Beta_DAC

CPZ_Beta_Loop00:
	smpsCall            CPZ_Beta_Call00
	smpsLoop            $00, $03, CPZ_Beta_Loop00
	smpsCall            CPZ_Beta_Call01

CPZ_Beta_Loop01:
	smpsCall            CPZ_Beta_Call00
	smpsLoop            $00, $02, CPZ_Beta_Loop01
	smpsCall            CPZ_Beta_Call01
	smpsJump            CPZ_Beta_Loop00
