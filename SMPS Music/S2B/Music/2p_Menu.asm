...
smpsHeaderStartSong = 1
	smpsHeaderVoice     Menu_2P_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $05

	smpsHeaderDAC       Menu_2P_Beta_DAC
	smpsHeaderFM        Menu_2P_Beta_FM1,	$F4, $10
	smpsHeaderFM        Menu_2P_Beta_FM2,	$F4, $0C
	smpsHeaderFM        Menu_2P_Beta_FM3,	$F4, $19
	smpsHeaderFM        Menu_2P_Beta_FM4,	$F4, $11
	smpsHeaderFM        Menu_2P_Beta_FM5,	$F4, $10
	smpsHeaderPSG       Menu_2P_Beta_PSG1,	$D0, $01, $00, $00
	smpsHeaderPSG       Menu_2P_Beta_PSG2,	$D0, $01, $00, $00
	smpsHeaderPSG       Menu_2P_Beta_PSG3,	$D0, $01, $00, $00
...
Menu_2P_Beta_FM1:
	...
	smpsAlterVol        $03
	dc.b	nRst, $02
	smpsCall            Menu_2P_Beta_Call03
	dc.b	nD6, $16
	smpsAlterVol        $FD
	smpsSetvoice        $05
	smpsPan             panRight, $00
	smpsAlterVol        $FB
	smpsCall            Menu_2P_Beta_Call01
	smpsCall            Menu_2P_Beta_Call01
	smpsAlterVol        $05
	smpsPan             panCenter, $00
	smpsSetvoice        $01
	smpsCall            Menu_2P_Beta_Call05
	...
	dc.b	$0C, nCs6
	smpsJump            Menu_2P_Beta_FM1

Menu_2P_Beta_Call03:
	smpsCall            Menu_2P_Beta_Call0C
...
Menu_2P_Beta_Loop01:
	...
	smpsLoop            $00, $18, Menu_2P_Beta_Loop01
	smpsCall            Menu_2P_Beta_Call04

Menu_2P_Beta_Loop02:
	dc.b	nE3, nE4, $03, $03, nE3, $06, nE4
	smpsLoop            $00, $02, Menu_2P_Beta_Loop02

Menu_2P_Beta_Loop03:
	dc.b	nFs3, nFs4, $03, $03, nFs3, $06, nFs4
	smpsLoop            $00, $02, Menu_2P_Beta_Loop03
	smpsCall            Menu_2P_Beta_Call04
	...
	smpsJump            Menu_2P_Beta_Loop01

Menu_2P_Beta_Call04:
	dc.b	nG3, nG4, $03, $03, nG3, $06, nG4
	smpsLoop            $01, $02, Menu_2P_Beta_Call04

Menu_2P_Beta_Loop04:
	dc.b	nFs3, nFs4, $03, $03, nFs3, $06, nFs4
	smpsLoop            $01, $02, Menu_2P_Beta_Loop04
	smpsReturn

; FM3 Data
Menu_2P_Beta_FM3:
	smpsSetvoice        $02
	smpsCall            Menu_2P_Beta_Call00
	smpsAlterVol        $F9
	...
	smpsAlterVol        $F2
	smpsPan             panRight, $00
	smpsCall            Menu_2P_Beta_Call02
	smpsPan             panCenter, $00
	smpsAlterVol        $0E
	smpsJump            Menu_2P_Beta_FM3
...
Menu_2P_Beta_Loop00:
	...
	smpsLoop            $00, $18, Menu_2P_Beta_Loop00
	smpsAlterVol        $FD
	dc.b	nRst, $0C, nD6, nRst, nE6, nRst, nFs6, nRst, nG6, $18, nRst, $24
	smpsJump            Menu_2P_Beta_Jump00
...
Menu_2P_Beta_Jump02:
	smpsCall            Menu_2P_Beta_Call06
	smpsPSGAlterVol     $01
	smpsCall            Menu_2P_Beta_Call06
	smpsCall            Menu_2P_Beta_Call06
	smpsCall            Menu_2P_Beta_Call07
...
Menu_2P_Beta_DAC:
	...
	smpsLoop            $00, $0A, Menu_2P_Beta_DAC
	dc.b	dKick, $06, dMidTom, $06, $06, $06, $0C, $0C
	smpsJump            Menu_2P_Beta_DAC
