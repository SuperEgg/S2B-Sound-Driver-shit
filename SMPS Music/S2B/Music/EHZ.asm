...
smpsHeaderStartSong = 1
	smpsHeaderVoice     EHZ_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $0E

	smpsHeaderDAC       EHZ_Beta_DAC
	smpsHeaderFM        EHZ_Beta_FM1,	$00, $0E
	smpsHeaderFM        EHZ_Beta_FM2,	$00, $16
	smpsHeaderFM        EHZ_Beta_FM3,	$00, $16
	smpsHeaderFM        EHZ_Beta_FM4,	$00, $20
	smpsHeaderFM        EHZ_Beta_FM5,	$00, $25
	smpsHeaderPSG       EHZ_Beta_PSG1,	$DC, $04, $00, fTone_03
	smpsHeaderPSG       EHZ_Beta_PSG2,	$DC, $04, $00, fTone_01
	smpsHeaderPSG       EHZ_Beta_PSG3,	$00, $02, $00, fTone_02
...
EHZ_Beta_Loop06:
	...
	dc.b	$30
	smpsLoop            $00, $04, EHZ_Beta_Loop06
	smpsSetvoice        $02
	smpsAlterVol        $FC
	smpsPan             panLeft, $00
...
EHZ_Beta_Loop05:
	...
	dc.b	$30
	smpsLoop            $00, $04, EHZ_Beta_Loop05
	smpsAlterPitch      $F4
	smpsSetvoice        $02
	smpsPan             panCenter, $00
...
EHZ_Beta_Loop04:
	...
	smpsLoop            $00, $04, EHZ_Beta_Loop04
...
EHZ_Beta_Loop0B:
	dc.b	nG5, $30, smpsNoAttack, $30, nA5, smpsNoAttack, $30, nF5, smpsNoAttack, $30, nE5, smpsNoAttack
	dc.b	$30
	smpsLoop            $00, $04, EHZ_Beta_Loop0B
	dc.b	nRst, $30, nRst
...
EHZ_Beta_Loop0A:
	dc.b	nE5, $30, smpsNoAttack, $30, nFs5, smpsNoAttack, $30, nD5, smpsNoAttack, $30, nC5, smpsNoAttack
	dc.b	$30
	smpsLoop            $00, $04, EHZ_Beta_Loop0A
	smpsModOff
	smpsPSGAlterVol     $FD
	dc.b	nRst, $30, nRst
	smpsPSGvoice        $00
...
EHZ_Beta_Loop07:
	...
	dc.b	nA5, $0C, $06, nA5
	smpsLoop            $00, $07, EHZ_Beta_Loop07
	dc.b	nA5, $0C, $06, nA5, nA5, $0C, $06, nA5, nA5, $0C, $06, nA5
	dc.b	nA5, $0C
...
EHZ_Beta_Loop08:
	dc.b	nA5, $0C, $06, nA5, nA5, $0C, $06, nA5, nA5, $0C, $06, nA5
	dc.b	nA5, $0C, $06, nA5
	smpsLoop            $00, $07, EHZ_Beta_Loop08
	dc.b	nA5, $0C, $06, nA5, nA5, $0C, $06, nA5, nA5, $0C, $06, nA5
	smpsPSGvoice        fTone_03
	dc.b	nA5, $0C
	smpsPSGvoice        fTone_02
...
EHZ_Beta_Loop09:
	...
	smpsLoop            $00, $03, EHZ_Beta_Loop09
	dc.b	nA5, $0C, $06, nA5, nA5, $0C, $06, nA5, nA5, $0C, $06, nA5
	smpsPSGvoice        fTone_03
	dc.b	nA5, $0C
	smpsPSGvoice        fTone_02
