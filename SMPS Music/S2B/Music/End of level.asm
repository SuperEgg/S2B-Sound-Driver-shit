...
smpsHeaderStartSong = 1
	smpsHeaderVoice     Results_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $03

	smpsHeaderDAC       Results_Beta_DAC
	smpsHeaderFM        Results_Beta_FM1,	$F4, $0A
	smpsHeaderFM        Results_Beta_FM2,	$DC, $0A
	smpsHeaderFM        Results_Beta_FM3,	$F4, $15
	smpsHeaderFM        Results_Beta_FM4,	$F4, $15
	smpsHeaderFM        Results_Beta_FM5,	$F4, $14
	smpsHeaderPSG       Results_Beta_PSG1,	$D0, $05, $00, fTone_05
	smpsHeaderPSG       Results_Beta_PSG2,	$DC, $07, $00, fTone_05
	smpsHeaderPSG       Results_Beta_PSG3,	$DC, $00, $00, fTone_04
