...
smpsHeaderStartSong = 1
	smpsHeaderVoice     OOZ_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $04

	smpsHeaderDAC       OOZ_Beta_DAC
	smpsHeaderFM        OOZ_Beta_FM1,	$F4, $0C
	smpsHeaderFM        OOZ_Beta_FM2,	$F4, $09
	smpsHeaderFM        OOZ_Beta_FM3,	$F4, $12
	smpsHeaderFM        OOZ_Beta_FM4,	$F4, $12
	smpsHeaderFM        OOZ_Beta_FM5,	$C4, $09
	smpsHeaderPSG       OOZ_Beta_PSG1,	$D0, $04, $04, $00
	smpsHeaderPSG       OOZ_Beta_PSG2,	$D0, $05, $04, $00
	smpsHeaderPSG       OOZ_Beta_PSG3,	$FE, $05, $00, fTone_01

; FM1 Data
OOZ_Beta_FM1:
	smpsSetvoice        $04
	smpsModSet          $02, $03, $01, $03
	smpsCall            OOZ_Beta_Call02

OOZ_Beta_Jump00:
	smpsSetvoice        $02
	smpsAlterPitch      $DC
	smpsCall            OOZ_Beta_Call03
	smpsAlterPitch      $24
	smpsSetvoice        $04
	smpsCall            OOZ_Beta_Call04
	smpsSetvoice        $02
	smpsAlterVol        $FD
	smpsAlterPitch      $DC
	smpsCall            OOZ_Beta_Call05
	smpsAlterVol        $03
	smpsAlterPitch      $24
	smpsAlterPitch      $E8
	smpsSetvoice        $05
	smpsAlterVol        $07
	smpsCall            OOZ_Beta_Call06
	smpsAlterVol        $F9
	smpsAlterPitch      $18
	smpsJump            OOZ_Beta_Jump00
...
OOZ_Beta_Loop09:
	...
	smpsLoop            $01, $02, OOZ_Beta_Loop09
	smpsReturn

OOZ_Beta_Call05:
	smpsCall            OOZ_Beta_Call07
...
OOZ_Beta_Loop07:
	smpsCall            OOZ_Beta_Call01
	dc.b	nRst, $12
	smpsCall            OOZ_Beta_Call01
	dc.b	nRst, $06, nF4, $03, nRst, nF4, nG4
	smpsLoop            $00, $04, OOZ_Beta_Loop07
...
OOZ_Beta_Loop04:
	...
	smpsLoop            $00, $08, OOZ_Beta_Loop04

OOZ_Beta_Loop05:
	dc.b	nRst, $06, nBb5, $03, nBb5, nRst, nBb5, nRst, $06, nBb5, $09, nBb5
	dc.b	$03, nRst, $0C
	smpsAlterPitch      $02
	smpsLoop            $00, $03, OOZ_Beta_Loop05
	smpsAlterPitch      $FA

OOZ_Beta_Loop06:
	dc.b	nA5, $03, nRst
	smpsLoop            $00, $08, OOZ_Beta_Loop06
	dc.b	nRst, $30
	smpsJump            OOZ_Beta_Loop04
...
OOZ_Beta_Loop08:
	...
	smpsLoop            $00, $0A, OOZ_Beta_Loop08
	dc.b	nRst, $30
	smpsJump            OOZ_Beta_Loop08
...
OOZ_Beta_Loop00:
	...
	smpsLoop            $00, $0A, OOZ_Beta_Loop00
	dc.b	nRst, $24, dSnare, $03, $03, dKick, $06
	smpsJump            OOZ_Beta_Loop00
