...
smpsHeaderStartSong = 1
	smpsHeaderVoice     CNZ_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $00

	smpsHeaderDAC       CNZ_Beta_DAC
	smpsHeaderFM        CNZ_Beta_FM1,	$0C, $10
	smpsHeaderFM        CNZ_Beta_FM2,	$F4, $12
	smpsHeaderFM        CNZ_Beta_FM3,	$F4, $12
	smpsHeaderFM        CNZ_Beta_FM4,	$00, $12
	smpsHeaderFM        CNZ_Beta_FM5,	$00, $12
	smpsHeaderPSG       CNZ_Beta_PSG1,	$DC, $02, $00, fTone_09
	smpsHeaderPSG       CNZ_Beta_PSG2,	$DC, $02, $00, fTone_09
	smpsHeaderPSG       CNZ_Beta_PSG3,	$00, $04, $00, fTone_01
...
CNZ_Beta_Loop03:
	...
	dc.b	nA5, $18
	smpsLoop            $00, $06, CNZ_Beta_Loop03
	smpsPSGvoice        fTone_01
	dc.b	nA5, $30, $18, $18
...
CNZ_Beta_Loop04:
	...
	smpsPSGvoice        fTone_02
	dc.b	nA5, $10, $08
	smpsLoop            $00, $44, CNZ_Beta_Loop04
	dc.b	nRst, $30, nRst, nRst, $30, nRst
	smpsJump            CNZ_Beta_Loop03
...
CNZ_Beta_Loop00:
	...
	smpsLoop            $00, $05, CNZ_Beta_Loop00
...
CNZ_Beta_Loop01:
	dc.b	dKick, $18, dSnare, $10, dKick, $08, $10, dSnare, $18, dKick, $08, $18
	dc.b	dSnare, $10, dKick, $08, $10, dMidTom, $08, dLowTom, $18
	smpsLoop            $00, $03, CNZ_Beta_Loop01
	dc.b	dKick, $18, dSnare, $10, dKick, $08, $10, dSnare, $18, dKick, $08, $10
...
CNZ_Beta_Loop02:
	...
	dc.b	dSnare, $18, $08
	smpsLoop            $00, $02, CNZ_Beta_Loop02
