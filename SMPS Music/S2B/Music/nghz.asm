...
smpsHeaderStartSong = 1
	smpsHeaderVoice     ARZ_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $08

	smpsHeaderDAC       ARZ_Beta_DAC
	smpsHeaderFM        ARZ_Beta_FM1,	$0C, $0F
	smpsHeaderFM        ARZ_Beta_FM2,	$00, $0F
	smpsHeaderFM        ARZ_Beta_FM3,	$00, $13
	smpsHeaderFM        ARZ_Beta_FM4,	$00, $0F
	smpsHeaderFM        ARZ_Beta_FM5,	$00, $0F
	smpsHeaderPSG       ARZ_Beta_PSG1,	$D0, $03, $00, fTone_01
	smpsHeaderPSG       ARZ_Beta_PSG2,	$D0, $04, $00, fTone_01
	smpsHeaderPSG       ARZ_Beta_PSG3,	$00, $01, $00, fTone_02
...
ARZ_Beta_Loop06:
	...
	smpsLoop            $00, $02, ARZ_Beta_Loop06
...
ARZ_Beta_Loop07:
	...
	dc.b	$0C, nC4
	smpsLoop            $00, $02, ARZ_Beta_Loop07
	smpsSetvoice        $01
	smpsAlterVol        $04
...
ARZ_Beta_Loop04:
	...
	smpsLoop            $00, $02, ARZ_Beta_Loop04
...
ARZ_Beta_Loop05:
	...
	dc.b	nFs3, $0C, nA3
	smpsLoop            $00, $02, ARZ_Beta_Loop05
	smpsSetvoice        $01
	smpsModSet          $02, $02, $01, $02
	smpsAlterVol        $04
	smpsPan             panLeft, $00
...
ARZ_Beta_Loop00:
	...
	smpsLoop            $00, $03, ARZ_Beta_Loop00
...
ARZ_Beta_Loop01:
	dc.b	dKick, $0C, dSnare, $06, dKick, $12, dClap, $06, $12, $06, dKick, $0C
	dc.b	dSnare, $06, dKick, dClap
	smpsLoop            $00, $03, ARZ_Beta_Loop01
...
ARZ_Beta_Loop02:
	...
	smpsLoop            $00, $03, ARZ_Beta_Loop02
...
ARZ_Beta_Loop0A:
	...
	dc.b	nRst, $12
	smpsLoop            $00, $02, ARZ_Beta_Loop0A
...
ARZ_Beta_Loop09:
	...
	dc.b	nRst, $12
	smpsLoop            $00, $02, ARZ_Beta_Loop09
...
ARZ_Beta_Loop08:
	...
	smpsLoop            $00, $13, ARZ_Beta_Loop08
	dc.b	nA5, $06, nA5, nA5, nRst, $12, nA5, $06, nA5, nA5, nRst, $2A
	smpsJump            ARZ_Beta_Loop08
