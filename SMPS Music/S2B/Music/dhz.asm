...
smpsHeaderStartSong = 1
	smpsHeaderVoice     MCZ_Beta_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $03

	smpsHeaderDAC       MCZ_Beta_DAC
	smpsHeaderFM        MCZ_Beta_FM1,	$00, $0C
	smpsHeaderFM        MCZ_Beta_FM2,	$00, $10
	smpsHeaderFM        MCZ_Beta_FM3,	$00, $0C
	smpsHeaderFM        MCZ_Beta_FM4,	$00, $10
	smpsHeaderFM        MCZ_Beta_FM5,	$00, $10
	smpsHeaderPSG       MCZ_Beta_PSG1,	$DC, $04, $00, fTone_0B
	smpsHeaderPSG       MCZ_Beta_PSG2,	$DC, $02, $00, fTone_01
	smpsHeaderPSG       MCZ_Beta_PSG3,	$00, $03, $00, fTone_02
...
MCZ_Beta_Call03:
	...
	dc.b	nRst, nRst
	smpsCall            MCZ_Beta_Call04
	dc.b	nRst, $30, nRst
	smpsAlterPitch      $03
	smpsCall            MCZ_Beta_Call05
	dc.b	nRst, $30, nRst
	smpsAlterPitch      $FD
	smpsCall            MCZ_Beta_Call04
...
MCZ_Beta_Loop03:
	...
	smpsLoop            $00, $04, MCZ_Beta_Loop03
	dc.b	nRst, $01
	smpsCall            MCZ_Beta_Call00
...
MCZ_Beta_Jump03:
	smpsCall            MCZ_Beta_Call01
	smpsModSet          $18, $01, $0A, $04
	smpsCall            MCZ_Beta_Call02
	smpsModSet          $18, $01, $0A, $04
	smpsCall            MCZ_Beta_Call03
	smpsJump            MCZ_Beta_Jump03
...
MCZ_Beta_Loop04:
	...
	smpsLoop            $00, $07, MCZ_Beta_Loop04
	dc.b	nA5, $0C, nE6, $08, nA5, $0C, nC6, nA5, $06, nRst, $2E
	smpsJump            MCZ_Beta_Jump06
...
MCZ_Beta_Loop02:
	...
	smpsLoop            $00, $07, MCZ_Beta_Loop02
	smpsAlterVol        $FA
	dc.b	nA5, $0C, nE6, $08, nA5, $0C, nC6, nA5, $06, nRst, $2E
	smpsPan             panRight, $00
	smpsJump            MCZ_Beta_Jump02
...
MCZ_Beta_Loop01:
	...
	dc.b	nE3, $04, nRst, $18
	smpsLoop            $00, $08, MCZ_Beta_Loop01
...
MCZ_Beta_Loop00:
	...
	smpsLoop            $00, $04, MCZ_Beta_Loop00
	smpsCall            MCZ_Beta_Call00
	smpsPan             panRight, $00
	smpsAlterPitch      $F4
