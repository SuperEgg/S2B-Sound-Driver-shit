...
GHZ_Credit_FM1_Start:	
	smpsCall            GHZ_Credit_FM1_Notes
...
MZ_Credit_FM1_Start:	
	...
	smpsCall            MZ_Credit_FM1_Notes
	
SLZ_Credit_FM1_Start:	
	smpsSetvoice        $0B
	smpsAlterVol        $EB
	dc.b	nRst, $0C, nG5, nA5, nG6
	smpsCall            SLZ_Credit_FM1_Notes
	dc.b	nE6, $1E, nE7, $06, nC7, $18, nRst, $24
	
SBZ_Credit_FM1_Start:	
	smpsNop             $01
	smpsSetTempoMod     $0A
	smpsSetvoice        $0F
	smpsAlterPitch      $0C
	smpsAlterVol        $0B
	smpsCall            SBZ_Credit_FM1_Notes
	
SYZ_Credit_FM1_Start:	
	smpsNop             $01
	smpsSetTempoMod     $07
	dc.b	nRst, $60
	smpsNop             $01
	...
	smpsSetvoice        $17
	smpsAlterVol        $0E
	smpscall 			SYZ_Credit_FM1_Notes
Credit_Outro_FM1_Start:	
	smpsNop             $01
	smpsSetTempoMod     $04
	smpsAlterVol        $F5
	smpsSetvoice        $1A
	dc.b	nRst, $60
	smpsCall            Credits_Outro_Notes
	smpsAlterVol        $09
	smpsAlterNote       $03
	smpsSetvoice        $18
	smpsModSet          $00, $01, $06, $04
	smpsCall            Credits_Outro_Final_Notes
	smpsAlterVol        $EF
	smpsSetvoice        $1B
	smpsAlterNote       $02
...
Credits_Outro_Notes:
	...
	smpsLoop            $00, $02, Credits_Outro_Notes
	smpsReturn
...
Credits_Intro_Notes:
	smpsCall            Credits_Intro_Actual_Notes
	dc.b	nFs5, nD5, nE5, nFs5, nD5
	smpsCall            Credits_Intro_Actual_Notes
	dc.b	nB5, nA5, nB5, nC6, nD6
	smpsReturn

Credits_Intro_Actual_Notes:
...
MZ_Credit_FM1_Notes:
	...
	smpsLoop            $00, $03, MZ_Credit_FM1_Notes
